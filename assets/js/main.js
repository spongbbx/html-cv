...
// Funkcja pomocnicza do ukrywania wszystkich sekcji
function hideAllSections() {
  var sections = document.querySelectorAll('.col-xxl-8.col-xl-9.cancel');
...
// Loop through the NodeList and remove the "active" class from each element
  activeElements.forEach(element => {
  element.classList.remove('active');
});
};

// Funkcje odpowiedzialne za pokazywanie poszczególnych sekcji
function about() {
  hideAllSections();
  ...
  disablebtn();
  var selectbtn = document.getElementById('aboutbtn');
...
function skills() {
  ...
  element.classList.add('show');
  disablebtn();
  var selectbtn = document.getElementById('skillsbtn');
  selectbtn.classList.add('active');
}

function rewards() {
  hideAllSections();
  var element = document.getElementById('rewards');
  element.classList.remove('hidden');
  element.classList.add('show');
  disablebtn();
  var selectbtn = document.getElementById('rewardsbtn');
  selectbtn.classList.add('active');
}

function certs() {
  hideAllSections();
  var element = document.getElementById('certs');
  element.classList.remove('hidden');
  element.classList.add('show');
  disablebtn();
  var selectbtn = document.getElementById('certsbtn');
  selectbtn.classList.add('active');
}
...
function edu() {
  ...
  element.classList.add('show');
  disablebtn();
  var selectbtn = document.getElementById('edubtn');
  selectbtn.classList.add('active');
}
...
function portfolio() {
  ...
  element.classList.add('show');
  disablebtn();
  var selectbtn = document.getElementById('portfoliobtn');
  selectbtn.classList.add('active');
}
...
function hobby() {
  ...
  element.classList.add('show');
  disablebtn();
  var selectbtn = document.getElementById('hobbybtn');
  selectbtn.classList.add('active');
}
